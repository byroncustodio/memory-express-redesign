...
namespace MemoryExpress.Infrastructure.Services.Catalog
{
    public class ManufacturerService : IManufacturerService
    {
        ...
        public ManufacturerService(ApplicationDbContext context, IRepository<Manufacturer> manufacturerRepository, IRepository<ProductManufacturerMapping> productManufacturerRepository)
        {
            _context = context;
