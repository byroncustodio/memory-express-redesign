...
namespace MemoryExpress.Infrastructure.Services.Catalog
{
    public class CategoryService : ICategoryService
    {
        ...
        public CategoryService(ApplicationDbContext context, IRepository<Category> categoryRepository, IRepository<ProductCategoryMapping> productCategoryRepository)
        {
            _context = context;
        ...
        {
            var entities = _categoryRepository.FindManyByExpression(x => x.ParentCategoryId == null)
                .OrderBy(x => x.Name)
                .ToList();
        ...
        public void DeleteCategories(IList<int> ids)
        {
            if (ids == null)
        ...
        public void DeleteAllProductCategoryMappingsByProductId(int productId)
        {
