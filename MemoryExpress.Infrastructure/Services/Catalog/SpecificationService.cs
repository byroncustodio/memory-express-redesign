...
namespace MemoryExpress.Infrastructure.Services.Catalog
{
    public class SpecificationService : ISpecificationService
    {
        ...
        public SpecificationService(ApplicationDbContext context, IRepository<Specification> specificationRepository, IRepository<ProductSpecificationMapping> productSpecificationMappingRepository)
        {
            _context = context;
